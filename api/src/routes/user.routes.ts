...
router.put('/:id/extra-resources', ensureAdmin, asyncHandler(updateUserExtraResources));

// Get total resource usage and allowed for a user (by admin or self)
router.get('/:id/resource-usage', ensureAuthenticated, asyncHandler(getUserResourceUsage));

// Get total resource usage and allowed for the current user
router.get('/me/resource-usage', ensureAuthenticated, asyncHandler(getUserResourceUsage));
...
router.get('/me/settings-stats', ensureAuthenticated, asyncHandler(getUserSettingsStats));
